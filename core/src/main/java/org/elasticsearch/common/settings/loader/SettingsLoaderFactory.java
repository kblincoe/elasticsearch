...
public final class SettingsLoaderFactory {
     ...
     * name. This factory method assumes that if the resource name ends with
     * ".yml" or ".yaml" then the content should be parsed as YAML,
     * otherwise throws an exception. Note that the parser returned by
     * this method will not accept null-valued keys.
     *
     ...
     * contains a ':' then the content should be parsed as YAML, and
     * otherwise throws an exception. Note that the YAML parser returned
     * by this method will accept null-valued keys.
     *
     ...
     * Note only {@link XContentType#YAML} is supported.
     *
